...
public class MCFUtils 
{
	...
	public static String getMFCTranspondersXTAwareInfo (int C)
	{
		...
		if (C == 7)		
			transponders += "40 2 2 13851 1; 100 3 3 5540 1; 100 2 2 2375 1; 200 3 3 1187 1; 400 4 4 229 1 "; 
		else if (C == 12)
			transponders += "40 2 2 12190 1; 100 3 3 5540 1; 100 2 2 2375 1; 200 3 3 1187 1; 400 4 4 229 1 "; 
		else if (C == 19)
			transponders += "40 3 3 4755 1; 40 2 2 2383 1; 100 3 3 2383 1; 100 2 2 599 1; 200 3 3 599 1; 400 4 4 150 1 "; 
		
//		if (C == 7)		
//			transponders += "40 2 2 13851 1; 40 2 2 5937 1; 40 2 2 2289 1; 100 3 3 5540 1; 100 2 2 2375 1; 100 2 2 916 1; 200 3 3 1187 1; 200 3 3 458 1; 400 4 4 229 1 "; 
//		else if (C == 12)
//			transponders += "40 2 2 12190 1; 40 2 2 3062 1; 40 2 2 726 1; 100 3 3 5540 1; 100 2 2 2375 1; 100 2 2 769 1; 200 3 3 1187 1; 200 3 3 458 1; 400 4 4 229 1 "; 
//		else if (C == 19)
//			transponders += "40 3 3 4755 1; 40 2 2 2383 1; 40 2 2 599 1; 40 2 2 150 1; 100 3 3 2383 1; 100 2 2 599 1; 100 2 2 150 1; 200 3 3 599 1; 200 3 3 150 1; 400 4 4 150 1 "; 
